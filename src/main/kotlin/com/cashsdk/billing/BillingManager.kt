...
internal class BillingManager(
    ...
    private val purchasesListener = PurchasesUpdatedListener { result, purchases ->
        when (result.responseCode) {
            ...
            else -> failWaiters(CashSDKError.Billing(result.responseCode, result.debugMessage))
        }
    }
    ...
    private val billingClient: BillingClient = BillingClient.newBuilder(context.applicationContext)
        ...
        .enablePendingPurchases(
            // Billing 7 requires an explicit PendingPurchasesParams.
    ...
    suspend fun purchase(activity: Activity, productId: String, kind: PurchaseKind): Entitlements {
        ...
        val purchase = try {
            ...
            if (launch.responseCode != BillingResponseCode.OK) {
                throw CashSDKError.Billing(launch.responseCode, launch.debugMessage)
            }
